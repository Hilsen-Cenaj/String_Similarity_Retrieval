...
public class Indexer {
    ...
    public Indexer() throws Exception{
        ...
        String txtfile =  "NPL-collection//doc-text.txt"; //txt file to be parsed and indexed, it contains one document per line
    ...
    private void indexDoc(IndexWriter indexWriter, MyDoc mydoc){
        ...
        try {
            ...
            doc.add(body);
            String fullSearchableText = mydoc.getId() + " " + mydoc.getBody();
